...
class Fizzbuzz extends Component {
    ...
    buttonHandleFizz = () => {
        this.setState({ message: handleFizz(this.state.number) });
        console.log(this.state.message, 'before', this.state.count);
        this.updateCounter();
        console.log(this.state.message, 'after', this.state.count);
    };
